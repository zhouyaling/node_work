            ...
            if (msg.status.status_code == 0) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (data[i].week_rate >= 0) {
                        ...
                        $("#weekUV").css("color", "#ffffff");
                        $("#weekOpen").css("color", "#ffffff");
                    }
                    if (data[i].today == "today") { //今日pv
                        ...
                        if (data[i].yesterday_rate >= 0) {
                            $("#dayPV").css("color", "#ffffff");
                        } else {
                            $("#dayPV").css("color", "#ffffff");
                        }
                        if (data[i].week_rate >= 0) {
                            $("#weekPV").css("color", "#ffffff");
                        } else {
                            $("#weekPV").css("color", "#ffffff");
                        }
        ...
        success: function(msg) {
            if (msg.status.status_code == 0) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    html += "<div class='progress blue'><div class='progress-bar' style='width:" + ((data[i].count * 100 / total).toFixed(2) >= 100 ? 100 : (data[i].count * 100 / total).toFixed(2)) + "%;' ><div class='M-expand'></div></div></div></td><td width='15%' style='text-align:center;' >" + data[i].count + "</td>";
                    html += "</tr>";
                }
    ...
    $.ajax({
        ...
        success: function(msg) {
            if (msg.status.status_code == 0) {
                ...
                $("#HOUSE_BIND_RATE").html(data[0].HOUSE_BIND_RATE * 100 + "%");
